...
public class Commandtp extends EssentialsCommand
{
 ...
 public void run(final Server server, final User user, final String commandLabel, final String[] args) throws Exception
 {
  ...
  case 4:
   ...
   if (args.length == 4)
   {
    ...
    if (world == null)
    {
     throw new Exception(tl("invalidWorld", args[3]));
    }
   }
   ...
   final Location locpos = new Location(world, x2, y2, z2, user.getLocation().getYaw(), user.getLocation().getPitch());
  ...
  case 5:
   ...
   world = server.getWorld(args[4]);
   if (world == null)
   {
    throw new Exception(tl("invalidWorld", args[4]));
   }
   ...
   final Location locposother = new Location(world, x, y, z, target2.getLocation().getYaw(), target2.getLocation().getPitch());
 ...
 public void run(final Server server, final CommandSource sender, final String commandLabel, final String[] args) throws Exception
 {
  ...
  else if (args.length > 3)
  {
   ...
   final Location loc = new Location(world, x, y, z, target.getLocation().getYaw(), target.getLocation().getPitch());
